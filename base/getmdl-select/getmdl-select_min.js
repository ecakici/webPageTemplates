{
	...
	var getmdlSelect = {
		_addEventListeners: function (dropdown) {
			...
			var setSelectedItem = function (li,fireEvents=true) {
				...
				if (fireEvents && dropdown.onChange!=undefined){
					dropdown.onChange(hiddenInput.value);
				}
			...
			if (dropdown.disabled==undefined || dropdown.disabled==false){
